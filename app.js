...
function exibirTextoNaTela(tag, texto) {
  ...
  function gerarNumeroAleatorio() {
     ...
     if (listaDeNumerosSorteados.includes(numeroEscolhido)) {  //(aqui voce testa se o numero ja existe na lista)
         return gerarNumeroAleatorio();
    } else {
             listaDeNumerosSorteados.push(numeroEscolhido); //(aqui voce inclui o numero na lista)
